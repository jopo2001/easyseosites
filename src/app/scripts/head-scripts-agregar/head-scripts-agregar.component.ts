...
@Component({
  selector: 'app-head-scripts-agregar',
  templateUrl: './head-scripts-agregar.component.html',
  styleUrl: './head-scripts-agregar.component.css'
})
export class HeadScriptsAgregarComponent {
  ...
  guardarNuevoScript(): void {
    ...
    this.gralService.createScriptHead(formData).subscribe({
      next: () => {
